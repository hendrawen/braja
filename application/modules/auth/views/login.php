...
<head>
  ...
  <meta content="" name="author" />
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>assets/assets/plugins/magic/magic.css" />
...
<body >
   ...
   <!-- PAGE CONTENT --> 
    ...
    <div class="text-center">
        <img src="<?php echo base_url();?>assets/assets/img/logo.png" id="logoimg" alt=" Logo" />
    </div>
    <div class="tab-content">
        <div id="login" class="tab-pane active">
          <center><?php echo $error; ?></center>
            <form action="<?php echo $action; ?>" class="form-signin" method="post">
    ...
    <!--END PAGE CONTENT -->     
      ...
      <script src="<?php echo base_url();?>assets/assets/plugins/bootstrap/js/bootstrap.js"></script>
